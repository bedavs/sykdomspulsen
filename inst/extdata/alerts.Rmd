...
x_tag <- params$tag
x_county_code <- fhidata::norway_locations_current[municip_code==x_municip_code]$county_code
...
county_order <- fhidata::norway_locations_long_current[location_code %in% d$location_code]
county_order <- rbind(county_order[.N],county_order[-.N])
county_order <- county_order[.N:1]
d[,location_name:=factor(location_name, levels=unique(county_order$location_name))]
